  ...
  return (
    <section className="bg-surface-container-low py-24 px-8 relative">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Tab Content */}
        {active === "food" && <FreshFoodContent />}
        {active === "play" && <PlayFirstContent />}
        {active === "curriculum" && <CurriculumContent />}
        {active === "care" && <LovingCareContent />}
      </div>
    </section>
  );
}

function FreshFoodContent() {
  return (
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-6">
        ...
        <p className="text-on-surface-variant text-lg leading-relaxed">
          We believe that physical growth is the foundation for intellectual
          curiosity. Our meals are prepared daily in-house using organic
          ingredients, ensuring every child receives the nutrition they need to
          stay energized for a day of exploration.
        </p>
      ...
      <div className="rounded-xl bg-surface p-4 shadow-xl border-4 border-white transform -rotate-1">
        <img
          ...
          alt="Children eating healthy lunch at daycare"
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuBRx-AxYNVXMcL9O2C1kMydhaZW05JHyIj1W00zUYsDpJLPrt4qlWi9KORUECZr-WCf-Hqm-2In5qB2YcWXZANVIB1s1M1k5hxcopTdLGC7_l4BFbHYd8OyYFx89QfKEVL1OMzH5s7KB2HF4IDvv2ILtPQUdI8eh9U0mDz3-PlTTB641cPPNOezLTETr020t2mxzcrCuVa1xbvKnKqaCQea2IIeBOEM1e2gwDXTAIDSp6KiqOr_i2p9Yb076nFEPi0JQvAMeUaxZQY"
        />
      </div>
    </div>
  );
  ...
  return (
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-6">
        ...
        <p className="text-on-surface-variant text-lg leading-relaxed">
          At Kopila, play isn&apos;t a break from learning — it <em>is</em> learning.
          Research shows that children develop critical cognitive, social, and
          emotional skills through unstructured and guided play. We design every
          corner of our space to spark imagination and discovery.
        </p>
        <ul className="space-y-4">
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <span className="text-sm">
                Sand, water, textures, and nature — hands-on discovery every day.
              </span>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <span className="text-sm">
                Dress-up corners and pretend kitchens build empathy and language skills.
              </span>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <span className="text-sm">
                Our enclosed backyard offers climbing, gardening, and free movement.
              </span>
            </div>
          </li>
        </ul>
...
function LovingCareContent() {
  return (
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="space-y-6">
        <h2 className="font-display text-secondary text-4xl">
          Loving Care, Every Day
        </h2>
        <p className="text-on-surface-variant text-lg leading-relaxed">
          Above everything else, Kopila is a place of love. We keep our group
          small intentionally so every child gets individual attention,
          warm hugs, and the emotional safety they need to thrive. Our
          caregivers build genuine bonds with each family.
        </p>
        <ul className="space-y-4">
          <li className="flex items-start gap-4">
          ...
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <span className="text-sm">
                We teach children to name their feelings and express themselves with confidence.
              </span>
            </div>
          </li>
        </ul>
      ...
      <div className="rounded-xl bg-surface p-4 shadow-xl border-4 border-white transform rotate-1">
        <img
          className="rounded-lg w-full h-[350px] object-cover"
          alt="Caregiver reading to children in a cozy setting"
          src="https://lh3.googleusercontent.com/aida-public/AB6AXuBwKebReQCZnbCx1Qa7q9oKCdduoGrmnxrktyjQRIQvzcNus0jCLlgNe5m-b6sIqwv7JQcTonLMWX3wMVfYGIbW0RmWHqeqFWyOP2CpVz6pEvg37tZ7cDR6vEQ15Ks299HWidWEssqaiz1QfQXe_HNq5xCg1T-ecq6MJ2pl6LlshQ-qmxUR_A572nZZTd4IFZbEre7qwOokPCSSp04clzEOFQrs3TGvcFb4tVBvJNCAXBze_4_LhU_WsVysmMi6dJlzNGdtQGY-vwk"
        />
      </div>
    </div>
  );
